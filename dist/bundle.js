...
var _CopyFather = __webpack_require__(31);
...
var _Copy = __webpack_require__(30);
	...
	_createClass(CopyFather, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Copy2.default, { year: this.state.year, month: this.state.month })
			);
		}
	}]);
